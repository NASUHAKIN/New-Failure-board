const blogPosts = [
  {
    ...
    content: `
        ...
        <p>Every time we fail and get back up, we build mental toughness. This resilience is crucial for navigating the inevitable ups and downs of life.</p>

        <h3>2. It Provides Feedback</h3>
        <p>Failure gives us immediate, undeniable feedback about what doesn't work. This allows us to pivot, adjust our strategies, and move closer to what actually works.</p>

        <h3>3. It Fosters Innovation</h3>
        <p>Many of the world's greatest inventions were born from failed experiments. When we are not afraid to fail, we are free to take the risks necessary for true innovation.</p>
  ...
  },
  {
    ...
    content: `
        ...
        <h3>1. J.K. Rowling</h3>
        <p>Before Harry Potter became a global phenomenon, Rowling was a single mother living on welfare. Her manuscript was rejected by 12 publishers before finally being accepted.</p>

        <h3>2. Steve Jobs</h3>
        <p>At 30 years old, Steve Jobs was fired from Apple, the company he co-founded. He used this time to found NeXT and Pixar, eventually returning to Apple to lead it to unprecedented heights.</p>

        <h3>3. Oprah Winfrey</h3>
        <p>Oprah was fired from her first TV job as an anchor because she was deemed "unfit for television." She went on to become the undisputed queen of daytime TV.</p>
  ...
  },
  {
    ...
    content: `
        ...
        <p>Panic leads to more mistakes. Take a deep breath. Step away from the keyboard for a minute if you need to.</p>

        <h3>Step 2: Assess the Damage</h3>
        <p>What exactly happened? Did you delete a file? Drop a table? Push bad code? Understand the scope of the problem before trying to fix it.</p>

        <h3>Step 3: Communicate</h3>
        <p>If you're working on a team, tell someone immediately. Hiding the mistake will only make it worse. Your team is there to help you.</p>

        <h3>Step 4: Fix It (Carefully)</h3>
        <p>Work through the solution methodically. Restore from backup, revert the commit, or apply the patch. Double-check everything.</p>
